  ...
  return (
    <div className='w-10/12 mx-auto my-20'>
        ...
        <div className='text-center my-5'>
            <button onClick={()=> setSelectedButton("products")} className={`btn rounded-r-none rounded-l-2xl ${selectButton==="products"?"btn-primary":""}`}>{cardData.length}Products</button> 
